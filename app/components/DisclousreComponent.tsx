    ...
    <div className="w-full">
      ...
      >
        <Disclosure defaultOpen={isDefaultOpen}>
          {({ open }) => (
            <>
              <Disclosure.Button className=" focus-visible:ring-purple-500 flex w-full  items-center justify-between rounded-lg p-2 py-2 text-left text-sm font-medium focus:outline-none focus-visible:ring focus-visible:ring-opacity-75">
                <h2
                  className={classNames(
                ...
                <div className="flex items-center gap-2 ">
                  ...
                  <Icon
                    ...
                    } text-white h-5 w-5 ${iconClassName}`}
                  />
                </div>
              </Disclosure.Button>
              <Disclosure.Panel
